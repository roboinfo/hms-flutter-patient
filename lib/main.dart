        ...
        builder: (ctx, auth, _) { 
          ...
          return MaterialApp(
            ...
            routes: {
              ...
              DashboardScreen.routeName: (ctx) =>  DashboardScreen(auth.particularId,auth.userId),
              ...
              AddPaymentScreen.routeName: (ctx) => AddPaymentScreen(auth.particularId),
              ShowPayment.routeName: (ctx) => ShowPayment(auth.particularId),
              AllInvoicePayment.routeName: (ctx) => AllInvoicePayment(auth.particularId,auth.userId),
              DepositPayment.routeName: (ctx) => DepositPayment(auth.particularId,auth.userId),


              PatientAppointmentDetailsScreen.routeName: (ctx) => PatientAppointmentDetailsScreen(auth.particularId,auth.userId),
              ShowPatientAppointmentScreen.routeName: (ctx) => ShowPatientAppointmentScreen(auth.particularId,auth.userId),
              
              
              
              ShowTodaysAppointmentScreen.routeName: (ctx) => ShowTodaysAppointmentScreen(auth.particularId),
              ...
              DoctorDepartmentScreen.routeName: (ctx) => DoctorDepartmentScreen(auth.particularId, auth.userId),
              DoctorDetailProfile.routeName: (ctx) => DoctorDetailProfile(auth.particularId,auth.userId),
              DoctorListScreen.routeName: (ctx) => DoctorListScreen(auth.particularId,auth.userId),
              AppointmentFromDoctorScreen.routeName: (ctx) => AppointmentFromDoctorScreen(auth.particularId,auth.userId),
