...
class AllInvoicePayment extends StatefulWidget {
  ...
  @override
  AllInvoicePaymentState createState() => AllInvoicePaymentState(this.id,this.userid);
}
...
class AllInvoicePaymentState extends State<AllInvoicePayment> {
 ...
 Future<List<PaymentDetails>> _responseFuture() async {
   ...
   final patient_userid = this.userid;
    ...
    var data = await http.get(Auth().linkURL +"api/patientAllInvoices?id=${patient_id}");
                              ...
                              child: Column(
                                children: [
                                  ...
                                  ListTile(
                                    ...
                                    title:  Row(
                                        children: [
                                          Text(AppLocalizations.of(context).patientName),
                                          Padding(padding: EdgeInsets.only(right: 20),),
                                  ...
                                  ListTile(
                                    ...
                                    title:  Row(
                                        children: [
                                          Text(AppLocalizations.of(context).patientPhone),
                                          Padding(padding: EdgeInsets.only(right: 20),),
