...
class DepositPayment extends StatefulWidget {
  ...
  @override
  DepositPaymentState createState() => DepositPaymentState(this.id,this.userid);
}
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ButtonStyle(
                            backgroundColor: MaterialStateProperty.all(Colors.blue.withOpacity(.5)),
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(AppLocalizations.of(context).totalDeposit,
                              textAlign: TextAlign.center,
                              style: TextStyle(fontWeight: FontWeight.bold,fontSize: 12,color: Colors.white),
                              ),
                              Padding(padding: EdgeInsets.all(2)),
                              ...
                              ListTile(
                                ...
                                title:  Row(
                                    children: [
                                      ...
                                      Flexible(child: Text("${response2.data[index2].id}")),
                                    ],
                                  ),
                              ),
                              ...
                              ListTile(
                                ...
                                title:  Row(
                                    children: [
                                      Text("Patient Id: "),
                                      Padding(padding: EdgeInsets.only(right: 20),),
                                      Flexible(child: Text("${response2.data[index2].patient_id}")),
                                    ],
                                  ),
                              ),
                              ...
                              ListTile(
                                ...
                                title:  Row(
                                    children: [
                                      ...
                                      Padding(padding: EdgeInsets.only(right: 20),),
                                      Flexible(child: Text("${response2.data[index2].deposited_amount}")),
                                    ],
                                  ),
                              ),
                              ListTile(
                                ...
                                title:  Row(
                                    children: [
                                      Text("Payment Id:"),
                                      Padding(padding: EdgeInsets.only(right: 20),),
                                      Flexible(child: Text("${response2.data[index2].payment_id}")),
                                    ],
                                  ),
                              ),
                              ListTile(
                                ...
                                title:  Row(
                                    children: [
                                      Text("Date:"),
                                      Padding(padding: EdgeInsets.only(right: 20),),
                                      Flexible(child: Text("${response2.data[index2].date}")),
                                    ],
                                  ),
                              ),
