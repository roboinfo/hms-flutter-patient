...
class AddPaymentScreenState extends State<AddPaymentScreen> {
         ...
         showDialog(
                  ...
                  builder: (BuildContext context) {  
                    return  AlertDialog(  
                      ...
                      content: Text(AppLocalizations.of(context).paymentSuccessfullMessage),  
                      actions: [  
                        FlatButton(  
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      (_donemakingpayment)?Center(child: CircularProgressIndicator()):
                  ...
                  Form(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                            ...
                            child: Center(
                                  ...
                                  child: Center(
                                    child: new DropdownButtonFormField(
                                      decoration: InputDecoration(labelText: AppLocalizations.of(context).invoice),
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: AppLocalizations.of(context).depositAmount,
                                      hintText: AppLocalizations.of(context).depositAmount
                                    ),
                                    ...
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return AppLocalizations.of(context).depositAmountValidMessage;
                                      }
                                      return null;
                                    },
                                    onSaved: (valuez){
                            ...
                            child: Center(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    readOnly: true,
                                    decoration: InputDecoration(
                                      labelText: AppLocalizations.of(context).depositType,
                                      hintText: AppLocalizations.of(context).depositType
                                    ),
                                  
                                    validator: (value) {
                                      if (value.isEmpty) {
                                        return AppLocalizations.of(context).depositTypeValidMessage;
                                      }
                                      return null;
                                    },
                                  ),
                          ...
                          Padding(
                            ...
                            child: Center(
                                  ...
                                  child: new DropdownButtonFormField(
                                    ...
                                    decoration: InputDecoration(labelText: AppLocalizations.of(context).cardType),
                        ...
                        Container(
                          child: Image.asset('assets/images/creditcardlogos.png',
                          width: double.infinity,
                          height: 80,
                            ...
                            child: Center(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (value1) {
                                      if (value1.isEmpty) {
                                        return AppLocalizations.of(context).enterCardHolderName;
                                      }
                                      return null;
                                    },
                                    onSaved:(value){
                            ...
                            child: Center(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      labelText: AppLocalizations.of(context).exipryDate,
                                      hintText: AppLocalizations.of(context).enterExipryDate
                                    ),
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText: AppLocalizations.of(context).enterCvv
                                    ),
