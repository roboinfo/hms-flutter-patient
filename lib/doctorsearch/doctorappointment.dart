...
class AppointmentFromDoctorScreen extends StatefulWidget {
  ...
  @override
  AppointmentFromDoctorScreenScreenState createState() => AppointmentFromDoctorScreenScreenState(this.idd,this.useridd);
}
...
class AppointmentFromDoctorScreenScreenState extends State<AppointmentFromDoctorScreen> {
  ...
  onchangedDropdownDoctorItem(Doctor selectedDoctor1 ){
    setState(() {
      ...
      if( _date != ""){
        String getslot = Auth().linkURL +'api/getDoctorTimeSlop?doctor_id=' + _ddoctor +'&date=' +this._date;
            ...
            showDialog(
                      ...
                      builder: (BuildContext context) {  
                        return  AlertDialog(  
                          ...
                          content: Text(AppLocalizations.of(context).appointmentCreatedMessage),  
                          actions: [  
                            FlatButton(  
                              child: Text(AppLocalizations.of(context).ok),  
                              onPressed: () {  
                                Navigator.of(context).pushReplacementNamed(DoctorListScreen.routeName);
              ...
              child: Column(
                ...
                children: <Widget>[ 
                      ...
                      Container(
                        decoration: BoxDecoration(
                          border: Border(
                            bottom: BorderSide(width: 1.5, color: Colors.blue[100]),
                          )
                        ),
                        
                        child: new DropdownButtonFormField(
                          
                          decoration: InputDecoration(labelText: AppLocalizations.of(context).doctor,
                            border: InputBorder.none
                          ),
                          value: selectedDoctor, 
                          items: dropdownDoctorItems,
                          onChanged:(zval) {onchangedDropdownDoctorItem(zval);},
                      ...
                      child: TableCalendar(
                        ...
                        onDaySelected: (selectedDay, focusedDay) {
                          setState(() {
                            ...
                            String getslot = Auth().linkURL +'api/getDoctorTimeSlop?doctor_id='+_ddoctor+'&date='+formattedDate;
                            getDoctorSlot(getslot);
                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        top:BorderSide(width: 1, color: Colors.amber[200]),
                        bottom:BorderSide(width: 1, color: Colors.amber[200]),
                      )
                    ),
                    child: Scrollbar(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return Padding(
                            ...
                            child: TextButton(
                              ...
                              child: Container(
                                child: Center(
                                  child: Text("${doctorSlotList[index]}",
                                    style: TextStyle(
                                      fontSize: 13,
                              ...
                              showDialog(
                                      ...
                                      builder: (BuildContext context) {  
                                        return  AlertDialog(  
                                          ...
                                          content: Text(AppLocalizations.of(context).pleaseEnterValidInput),  
                                          actions: [  
                                            FlatButton(  
                                              child: Text(AppLocalizations.of(context).ok),  
                                              onPressed: () {  
