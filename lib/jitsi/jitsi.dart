...
class Jitsi extends StatefulWidget {
  ...
  String s_time;
  String e_time;
  Jitsi({this.p_name,this.link,this.d_name,this.d_date,this.s_time,this.e_time});
  @override
  JitsiState createState() => JitsiState(this.p_name,this.link,this.d_name,this.d_date,this.s_time,this.e_time);
}
...
class JitsiState extends State<Jitsi> {
  ...
  JitsiState(this.p_name,this.link,this.d_name,this.d_date,this.s_time,this.e_time){
